...
export const braingym_definition = {__html: `
  ...
  y el aprendizaje, a través del uso de ambos hemisferios cerebrales. <br/><br/>

  Creada por el doctor norteamericano Paul Dennison en los años 60; propone
  mejorar la atención, concentración, habilidades, la lectura y escritura, entre
  otras, a través de la resolución de problemas, rompecabezas y ejercicios cerebrales
  que pueden ser realizados en cualquier momento y lugar y por cualquier persona
`}

export const braingym_explanation = {__html: `
Para entender el funcionamiento de Brain Gym® tenemos que dividir el cerebro en tres partes interrelacionadas entre sí. La primera está fundamentada en el neocórtex, que implica la dimensión de la comunicación. La segunda, el sistema límbico, es la dimensión de la organización. Y la tercera y última, el cerebro reptiliano, con la dimensión de la atención.
<br /><br />
Brain Gym® ayuda a estimular (dimensión Lateralidad), liberar (dimensión Enfoque) y relajar (dimensión Centro) a cualquier adulto o niño ante situaciones difíciles, en el colegio, en el trabajo o en nuestras relaciones personales.
<br /><br />
